...
export default function ProApply() {
  ...
  // 📌 [수정] YOUR_FORM_ID 플레이스홀더를 삭제하고 실제 실주소를 직접 할당함
  const finalFormUrl = "https://docs.google.com/forms/d/e/1FAIpQLSfWgHevmewJwgcNY6mntC-neJlswAyQ-e8IU9x9_5u6lSoEJA/viewform";
          ...
          <div style={{ textAlign: 'center' }}>
            ...
            <div style={{ textAlign: 'left', marginBottom: '25px', padding: '15px', backgroundColor: theme.bg, borderRadius: '10px', border: `1px solid ${theme.border}` }}>
              ...
              <div style={{ marginTop: '12px', fontSize: '11px', color: theme.subText, lineHeight: '1.6' }}>
                ...
                • 보관 기간: 승인 처리 완료 후 지체 없이 파기합니다.
              </div>
            </div>

            {/* 📌 [수정] <a> 태그 단독 동작 구조 강화 - 오버레이 및 리다이렉트 로직 제거 */}
            <a
              href={isAgreed ? finalFormUrl : "javascript:void(0)"}
